 ...
 */
public class VTDemoW  extends Thread {
    ...
    public static void main (String args[]) throws Exception {
        ...
        int nTubeSections;
        if(args.length != 3) {
            System.out.println("Usage: java VTDemoW ncontrolpoints length srate");
            return;
        }
        ...
        double[] max = new double[nSliders];
                names[0] = "lip M ";
        val[0] = 1; min[0] = 0.1; max[0] = 100;
        names[1] = "lip damp";
        val[1] = .3; min[1] = 0.0; max[1] = 10;
        names[2] = "wall damp";
        val[2] = 1; min[2] = 0.0; max[2] = 10;
        ...
        double minLen = .10;
        final RightLoadedWebsterTube filter = new RightLoadedWebsterTube(srate,tm,minLen);
