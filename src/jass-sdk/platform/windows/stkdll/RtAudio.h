...
// Was 10 (Kees) making it 6 had no effect
...
class STKDLL_API RtAudio : public Object
{
protected:
...
public:
	...
	RtAudio(int channels, MY_FLOAT srate, const char *mode, int device = -1, int num_fragments = NUM_FRAGMENTS);
  ~RtAudio();
